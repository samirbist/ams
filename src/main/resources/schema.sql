...
CREATE TABLE `artcl` (
  ...
  `row_add_pgm_no` varchar(255) NOT NULL,
  `row_add_tms` date NOT NULL,
  `row_add_uid_no` varchar(255) NOT NULL,
  `row_updt_pgm_no` varchar(255) NOT NULL,
  `row_updt_tms` date NOT NULL,
  `row_updt_uid_no` varchar(255) NOT NULL,
...
CREATE TABLE `artcl_catg` (
  ...
  `row_add_pgm_no` varchar(255) DEFAULT NULL,
  `row_add_tms` date DEFAULT NULL,
  `row_add_uid_no` varchar(255) DEFAULT NULL,
  `row_updt_pgm_no` varchar(255) DEFAULT NULL,
  `row_updt_tms` date DEFAULT NULL,
  `row_updt_uid_no` varchar(255) DEFAULT NULL,
...
LOCK TABLES `genn_persn` WRITE;
/*!40000 ALTER TABLE `genn_persn` DISABLE KEYS */;
/*!40000 ALTER TABLE `genn_persn` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-05-12 20:08:24
